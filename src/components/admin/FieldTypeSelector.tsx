...
export default function FieldTypeSelector({ value, onChange, compact }: FieldTypeSelectorProps) {
  ...
  if (compact) {
    return (
      <div ref={ref} className="relative">
        ...
        {isOpen && (
          <div className="absolute z-50 top-full left-0 mt-1 w-72 bg-surface-card border border-border-default rounded-lg shadow-xl overflow-hidden">
  ...
  return (
    <div ref={ref} className="relative">
      ...
      {isOpen && (
        <div className="absolute z-50 top-full left-0 mt-1 w-full bg-surface-card border border-border-default rounded-lg shadow-xl overflow-hidden">
          <div className="p-2 border-b border-border-default">
            <div className="relative">
              <Search size={12} className="absolute left-2 top-1/2 -translate-y-1/2 text-text-muted" />
              <input
