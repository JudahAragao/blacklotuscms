        ...
        <div className="theme-container h-20 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-8">
            {menuItems.length > 0 ? (
              ...
              <Link href="/" className="text-sm font-bold text-slate-500 hover:text-primary label-caps tracking-widest">Home</Link>
            )}
          ...
          <div className="flex items-center gap-4">
             <Link href="/admin" className="theme-btn theme-btn-primary !py-2 !px-4 !text-[10px]">
                Admin Panel
             </Link>
          </div>
        </div>
