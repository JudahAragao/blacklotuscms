...
// source: prisma generate (DO NOT MODIFY DIRECTLY)

Types generated by Prisma for all entities: User, Role, ApiKey, PostType, Post, FieldGroup, Field, MetaValue, Taxonomy, Term, PostTerm, Plugin, PluginData, PluginPermission, Media, Setting, ThemeData, ThemePermission, Menu, MenuItem, Comment.
...
interface FieldConfig {
  ...
  validation?: {
    ...
    max?: number;
    pattern?: string;
    accept?: string; // Accepted types for file/image/gallery (e.g., "pdf, docx, xlsx")
  };
  conditionalLogic?: {
    status?: boolean;
    relation?: 'and' | 'or';
