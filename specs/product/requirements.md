...
- **FR05: Posts CRUD:** Create, read, update, delete posts with slug uniqueness, status management (draft/published/private), and SEO metadata
  ...
  - Status: implemented
  - Depende de: FR04
- **FR06: Custom Fields (MetaFields):** Extensible field system with typed config (text, image, repeater, etc.) linked to post types via FieldGroups
  - Prioridade: P1
  - Status: implemented
  - Depende de: FR04
...
- **FR10: Plugin System:** Install, activate, deactivate plugins via ZIP upload with isolated-vm sandbox execution
  ...
  - Status: implemented
  - Depende de: FR02
- **FR11: Theme System:** Dynamic theme loading with CSS variables, layout templates, and permission-gated data access
  - Prioridade: P1
  - Status: implemented
  - Depende de: FR04
