...
- [x] **TASK-002:** System de autenticação NextAuth + JWT | priority: P0 | est: 6h
- [x] **TASK-003:** Proxy/middleware with installation gate e auth | priority: P0 | est: 4h
- [x] **TASK-004:** SecretsService e Zero .env Architecture | priority: P0 | est: 4h
- [x] **TASK-005:** System de instalação web-based | priority: P0 | est: 8h
- [x] **TASK-006:** RBAC with capabilities JSON | priority: P0 | est: 6h
...
- [x] **TASK-009:** Post CRUD with MetaFields e Taxonomies | priority: P1 | est: 10h
...
- [x] **TASK-016:** Theme syshas with dynamic layouts | priority: P1 | est: 8h
...
- [x] **TASK-020:** Menu syshas hierarchical | priority: P2 | est: 4h
- [x] **TASK-021:** Comment syshas with anti-spam | priority: P2 | est: 5h
- [x] **TASK-022:** Search service (global search) | priority: P2 | est: 3h
- [x] **TASK-023:** Sithemep generation | priority: P2 | est: 2h
...
- [ ] **TASK-032:** SDD documentation withpleta | priority: P5 | est: 10h | depends: [] | feature: docs
