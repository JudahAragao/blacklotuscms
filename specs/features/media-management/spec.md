...
- **REQ-05:** Exclusao de arquivo fisico e registro no banco
...
- **Colaborador:** Sem acesso a midia
...
## Dependencies
- **Depende de:** Storage Driver, Authentication
- **Bloqueia:** Post editor (media picker), Theme images
