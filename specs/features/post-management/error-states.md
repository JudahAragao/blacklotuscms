...
- **Ação do system:** Retorna RESOURCE_NOT_FOUND
- **TEST DATA:** `{ "trigger": "id_inexistente", "expected_code": 404, "expected_message": "Post not found" }`

## ERR-02: Duplicate Slug
- **Condition:** Tentativa de criar/atualizar with slug que ja existe
- **Código HTTP:** 409 ou 400
- **Mensagem ao user:** "Slug already in use"
- **Ação do system:** Prisma unique constraint violation capturada
...
- **Ação do system:** Verificacao antes da criacao
...
- **Ação do system:** canPerformAction retorna false
...
- **Ação do system:** ZodError flattened
