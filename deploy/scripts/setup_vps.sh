...
echo "3. Access your site at https://blacklotuscms.com"
echo ""
echo "All persistent data (uploads, themes, plugins) is stored in Docker named volumes."
echo "Data persists across container restarts and redeployments."
echo ""
